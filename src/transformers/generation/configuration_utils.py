...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.repetition_penalty_range = kwargs.pop("repetition_penalty_range", 1024)
        self.repetition_penalty_slope = kwargs.pop("repetition_penalty_slope", 1.5)
        self.repetition_penalty_frequency = kwargs.pop("repetition_penalty_frequency", 0.0)
        self.repetition_penalty_presence = kwargs.pop("repetition_penalty_presence", 0.0)
        self.repetition_penalty_whitelist = kwargs.pop("repetition_penalty_whitelist", None)
